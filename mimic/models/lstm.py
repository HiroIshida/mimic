...
class LSTM(_Model):
    ...
    def loss(self, sample: torch.Tensor, state_slicer: Optional[slice] = None, reduction='mean') -> LossDict:
        ...
        loss_value = nn.MSELoss(reduction=reduction)(seq_pred[:, state_slicer], seq_pred_gt[:, state_slicer])
